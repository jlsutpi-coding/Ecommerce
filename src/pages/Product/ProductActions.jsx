  ...
  return (
    <div className=" flex flex-col gap-4 ">
      ...
      <button
        ...
        className=" hover:bg-[#f3f4f5] dark-transition flex items-center justify-center border-[#C5C5D4]/20 border font-manrope gap-3 w-full  py-5  active:scale-[0.98]  leading-7 tracking-[0.45px] rounded-lg   font-bold text-[18px] "
      >
