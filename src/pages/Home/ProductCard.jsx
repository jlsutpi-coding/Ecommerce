...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link className="" to={`/product/${id}`}>
      <div className=" w-70.5 h-112.25 flex flex-col gap-5  rounded-lg  ">
        ...
        <div className=" p-2 flex flex-col gap-[4.5px] ">
          <div className=" font-inter text-[#24389C] tracking-[1px] leading-3.75 font-semibold text-[10px] opacity-60">
